...
public class CurrencyConverter implements IConverter<BigDecimal> {
    ...
    private final DecimalFormat format = (DecimalFormat) NumberFormat.getInstance(Locale.GERMANY);
    ...
    public BigDecimal convertToObject(String s, Locale locale) throws ConversionException {
        try {
            ...
            throw new RuntimeException(String.format("%s kann nicht in ein BigDecimal konvertiert werden. ", s));
        }
    }
